...
import com.sabujak.contest.global.security.exception.TokenExtractionException;
...
public class JwtTokenProvider {
  ...
  private String createToken(String userUuid, Long expirationMillis, JwtTokenType type, String role) {
  ...
  public String createRefreshToken(String userUuid, String role) {
    return this.createToken(
        userUuid
